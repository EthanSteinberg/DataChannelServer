...
extern void CreatePeerConnection(const char* server, int port,
  ConnectCallback callback, void* user_data, MessageCallback error_callback, void* error_data);
...
void SetOnCloseCallback(PeerConnection* peer, CloseCallback callback, void *user_data);
